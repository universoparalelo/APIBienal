...
export interface ApiEscultorEscultor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    obras_previas: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::escultor.escultor',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiEsculturaEscultura extends Schema.CollectionType {
  ...
  attributes: {
    ...
    f_inicio: Attribute.Date;
    f_finalizacion: Attribute.Date;
    tematica: Attribute.Relation<
      'api::escultura.escultura',
      'oneToOne',
      'api::tematica.tematica'
    >;
    img_antes: Attribute.String;
    img_durante: Attribute.String;
    img_despues: Attribute.String;
    escultor: Attribute.Relation<
      'api::escultura.escultura',
      'oneToOne',
      'api::escultor.escultor'
    >;
...
export interface ApiImagenImagen extends Schema.CollectionType {
...
export interface ApiTematicaTematica extends Schema.CollectionType {
